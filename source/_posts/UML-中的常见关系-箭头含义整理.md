...
categories:
- UML
index_img: https://cdn.jsdelivr.net/gh/fanlusky/BlogMaps@master/blogs/pictures/20210607142649.png
banner_img: https://cdn.jsdelivr.net/gh/fanlusky/BlogMaps@master/blogs/pictures/20210607142649.png
---
...
![泛化（Generaliaztion）](https://cdn.jsdelivr.net/gh/fanlusky/BlogMaps@master/blogs/pictures/20210607124920.png)
...
![实现（Realization）](https://cdn.jsdelivr.net/gh/fanlusky/BlogMaps@master/blogs/pictures/20210607130417.png)
...
![组合（Composition）](https://cdn.jsdelivr.net/gh/fanlusky/BlogMaps@master/blogs/pictures/20210607131330.png)
...
![聚合（Aggregation）](https://cdn.jsdelivr.net/gh/fanlusky/BlogMaps@master/blogs/pictures/20210607131733.png)
...
![关联（Association）](https://cdn.jsdelivr.net/gh/fanlusky/BlogMaps@master/blogs/pictures/20210607141029.png)
...
![依赖（Dependency）](https://cdn.jsdelivr.net/gh/fanlusky/BlogMaps@master/blogs/pictures/20210607141757.png)
...
![](https://gitee.com/fanlusky/blog-pics-bed/raw/master/imgs/20200907170311.png)

### 2、实现（Interface implementation）

![](https://gitee.com/fanlusky/blog-pics-bed/raw/master/imgs/20200907170552.png)

### 3、依赖（Dependency）（“uses-a”）

概念：一种使用的关系，即一个类的实现需要另一个类的协助，Java中，如果一个类的方法操纵另一个类的对象，我们就说一个类依赖于另一个类。

![](https://gitee.com/fanlusky/blog-pics-bed/raw/master/imgs/20200907171334.png)
...
![](https://gitee.com/fanlusky/blog-pics-bed/raw/master/imgs/20200907172200.png)
...
![](https://gitee.com/fanlusky/blog-pics-bed/raw/master/imgs/20200907172818.png)
...
![](https://gitee.com/fanlusky/blog-pics-bed/raw/master/imgs/20200907173457.png)
